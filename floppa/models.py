...
class Customer(models.Model):
    userID = models.AutoField(max_length=8, unique=True)
...
class Necklace(models.Model):
    necklaceID = models.AutoField(max_length=8, unique=True)
...
class Wishlist(models.Model):
    wishlistID = models.AutoField(max_length=8, unique=True)
...
class Cart(models.Model):
    cartID = models.AutoField(max_length=8, unique=True)
    userID = models.OneToOneField(Customer, on_delete=models.CASCADE)
...
class Order(models.Model):
    orderID = models.AutoField(max_length=8, unique=True)
